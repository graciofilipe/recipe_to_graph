...
Heat the olive oil in a large pan and sauté the onions for 5-7 minutes, until soft.
Mince the garlic and add to the pan. (Can be done simultaneously to the previous step)
...
Your code should render the diagram and save it as "initial_recipe_flow.pdf". The output must be *only* Python code; no explanations or comments. Verify Python syntactic correctness.

**Constraints:**

* **Output:** *Only* valid, executable Python code using the `graphviz` library. No rendering or saving steps in the code itself, just the code to generate the graph object. Verify Python syntactic correctness.
