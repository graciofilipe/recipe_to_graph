...
from aux_vars import GENERATE_GRAPH_SYS_PROMPT, IMPROVE_GRAPH_SYS_PROMPT, RE_WRITE_SYS_PROMPT
...
if __name__ == "__main__":
    ...
    first_pass_graph = generate_graph(project_id=PROJECT_ID, recipe=recipe, si_text=GENERATE_GRAPH_SYS_PROMPT
    )
    ...
    improved_graph = improve_graph(
        project_id=PROJECT_ID, recipe=recipe, graph_code=first_pass_graph, si_text=IMPROVE_GRAPH_SYS_PROMPT
    )
