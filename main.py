...
if __name__ == "__main__":
    ...
    if recipe_file:
        ...
        recipe = re_write_recipe(
            project_id=PROJECT_ID, recipe=pre_recipe, input_type="txt"
        )

    elif youtube_url:
        recipe = youtube_url
        recipe = re_write_recipe(
            project_id=PROJECT_ID, recipe=youtube_url, input_type="youtube"
        )
    ...
    improved_graph = improve_graph(
        project_id=PROJECT_ID, recipe=recipe, graph_code=first_pass_graph
    )
